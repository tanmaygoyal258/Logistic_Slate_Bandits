...
import numpy as np
import sys
import Non_Stochastic_Slate_Bandits.CornerProbabilityPack as cp
...
def mixture_decomposition_ordered_stateless(slate_size, total_number_of_actions, matrix_to_be_decomposed):
    ...
    :param total_number_of_actions: number of the pairs in matrix s*K.
    :param matrix_to_be_decomposed: flattened scaled probability matrix of position, action pairs.
    ...
    corner_element = 1.0 / (slate_size)
    column_number = int(total_number_of_actions / slate_size)
