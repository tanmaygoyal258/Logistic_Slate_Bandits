...
from utils import sigmoid, dsigmoid, weighted_norm, gaussian_sample_ellipsoid , probit , dprobit
...
class TS_ECOLog():
    def __init__(self, params):
        ...
        self.theta_tilde = np.zeros((self.dim,))
        self.conf_radius = 0
        self.cum_loss = 0
        self.ctr = 1
    ...
    def pull(self, arm_set):
        ...
        self.theta_tilde = gaussian_sample_ellipsoid(self.theta, self.vtilde_matrix, self.conf_radius)
    ...
    def compute_optimistic_reward(self, arm):
        ...
        """
        pred_reward = self.reward_func(np.sum(self.theta_tilde * arm))
        return pred_reward
